...
function importInventories() {
    return __awaiter(this, void 0, void 0, function () {
        var projectRoot, excelPath, workbook, sheet, rows, updated, skipped, _i, rows_1, row, product, inventory;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    excelPath = (0, path_1.join)(projectRoot, "src/scripts/Inventario.xlsx");
                    workbook = xlsx.readFile(excelPath);
                    sheet = workbook.Sheets[workbook.SheetNames[0]];
                    rows = xlsx.utils.sheet_to_json(sheet);
                    updated = 0;
                    skipped = 0;
                    console.log("lets see whats happening: ", rows[0]);
                    _i = 0, rows_1 = rows;
                    _a.label = 2;
                case 2:
                ...
                case 3:
                    product = _a.sent();
                    if (!product) {
                        console.warn("\u274C Product not found for SKU: ".concat(row.sku));
                        skipped++;
                        return [3 /*break*/, 6];
                    }
...
importInventories().catch(function (err) {
