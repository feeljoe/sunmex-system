import { SupplierReceiptsTable } from "@/components/tables/SupplierReceiptsTable";
import Link from "next/link";

export default function SupplierReceiptsPage() {
  return (
    <div className="flex flex-col flex-1 w-full h-full gap-5 p-5">
        <h1 className="text-4xl font-bold text-center dark:text-white">Supplier Receipts</h1>
        <div className="flex items-center justify-end">
            <Link href="/pages/inventory/supplier-receipts/add-supplier-receipt">
