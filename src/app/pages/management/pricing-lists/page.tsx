import { PricingListsTable } from "@/components/tables/PricingListsTable";
import Link from "next/link";

export default function PaymentTermsPage() {
    return (
      <div className="flex flex-col flex-1 w-full h-full gap-5 p-5">
        <h1 className="text-4xl font-bold text-center dark:text-white">Pricing Lists</h1>
      <div className="flex items-center justify-end">
          <Link href="/pages/management/pricing-lists/add-pricing-list">
