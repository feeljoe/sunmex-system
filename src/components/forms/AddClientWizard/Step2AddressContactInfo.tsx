export function Step2AddressContactInfo({ form, setForm }: any) {
    ...
    return (
      <div className="mb-10">
        <h1 className="font-bold text-lg text-center">– Address Info –</h1>
        ...
        <div className="grid lg:grid-cols-2 gap-3 pt-5">   
            ...
            <input name='zipCode' value={form.zipCode} onChange={handleChange} placeholder='Zip Code' className='bg-white p-3 rounded shadow-xl h-15 text-gray-500'/>
        </div>
        <h1 className="font-bold text-lg text-center mt-5">– Contact Info –</h1>
        <div className='grid lg:grid-cols-2 gap-3 pt-5'>
            <input name='contactName' value={form.contactName} onChange={handleChange} placeholder='Contact Name' className='bg-white h-15 p-3 rounded shadow-xl text-gray-500'/>
            <input name='phoneNumber' inputMode="numeric" value={form.phoneNumber} onChange={handleChange} placeholder='Phone Number' className='bg-white h-15 p-3 rounded shadow-xl text-gray-500'/>
        </div>  
      </div>
    );
  }
