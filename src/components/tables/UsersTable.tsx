                ...
                <tbody>
                    {items.map((it:any) => (
                        <tr key={it._id} className="border-b">
                            ...
                            <td className='p-2 text-right whitespace-nowrap'>
                                <button className='text-white bg-red-500 px-2 py-2 text-lg rounded-xl hover:underline cursor-pointer hover:bg-red-300 hover:text-(--quarteary) transition-all duration:300' onClick={() => requestDelete(it)}>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
