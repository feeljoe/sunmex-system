...
export function SuppliersTable() {
  ...
  return (
    ...
    <div className="flex items-center justify-end py-2">
      <Link href="/pages/management/suppliers/add-supplier">
    ...
    <div className='flex flex-col w-full h-full bg-(--secondary) shadow-xl rounded-xl p-5'>
      ...
      <table className='w-full text-left font-mono'>
        ...
        {items.length === 0 && (
            <tr>
              <td colSpan={8} className='p-4 text-center font-bold text-gray-700'>
                No suppliers found
              </td>
            </tr>
          )}
          {items.map((it: any) => (
            <tr key={it._id} className='border-b font-bold'>
              ...
              <td className='p-2 text-right whitespace-nowrap'>
                  <button className='text-red-800 bg-red-400 p-2 text-lg rounded-xl hover:underline cursor-pointer hover:bg-red-800 hover:text-white transition-all duration:300' onClick={() => requestDelete(it)}>
